...
final class UpdateTests: XCTestCase {
    ...
    private func manifest(_ version: String) -> UpdateChecker.Manifest {
        UpdateChecker.Manifest(
            version: version,
            downloadURL: URL(string: "https://example.com/Chaff.dmg")!
        )
    }
    ...
    func testDecodesManifestProducedByPublishScript() throws {
        ...
        {
          "version": "0.2.0",
          "downloadURL": "https://github.com/agshwanbong-max/my-mac/releases/download/v0.2.0/Chaff-0.2.0.dmg",
        ...
        XCTAssertEqual(manifest.downloadURL.lastPathComponent, "Chaff-0.2.0.dmg")
    }
    ...
    func testVersionFileIsParsable() throws {
        let root = URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()  // ChaffCoreTests
